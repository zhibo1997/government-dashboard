            ...
            <div class="well-statistics">
                ...
                <div class="well-list">
                    <div class="well-item" v-for="item in wellData" :key="item.type">
                        ...
                        <div class="well-bar">
                            <div class="bar-bg">
                                <div class="bar-fill normal" :style="{ width: (item.normal / item.total * 100) + '%' }">
                                </div>
                                <div class="bar-fill abnormal"
                                    :style="{ width: (item.abnormal / item.total * 100) + '%' }"></div>
                            </div>
...
.gas-pipeline-module {
    ...
    .charts-container {
        ...
        .chart-wrapper {
            flex: 1;
            background: linear-gradient(135deg, rgba(0, 150, 255, 0.05) 0%, rgba(0, 100, 200, 0.02) 100%);
