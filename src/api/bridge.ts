...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  gspspDtransBridge = {
     ...
     * No description
     *
     * @name ZsBridgeLxtjListList
     * @summary 获取总览桥梁分类统计列表
     * @request GET:/gspspDtransBridge/zsBridgeLxtj/list
     */
    zsBridgeLxtjListList: (params: RequestParams = {}) =>
      this.request<object, any>({
        path: `/gspspDtransBridge/zsBridgeLxtj/list`,
        method: "GET",
        format: "json",
        ...params,
      }),
  ...
  gspspDtransPubmnteqpinfo = {
     ...
     * No description
     *
     * @name BridgeRateListList
     * @summary 桥梁专项-监测设备在线数量
     * @request GET:/gspspDtransPubmnteqpinfo/bridge/rateList
     */
