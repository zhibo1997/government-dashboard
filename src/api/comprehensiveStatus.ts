...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  zzts = {
     ...
     *
     * @name FxdjCountList
     * @summary 综合态势-专项风险等级数量统计
     * @request GET:/zzts/fxdj/count
     */
    fxdjCountList: (params: RequestParams = {}) =>
      this.request<object, any>({
        path: `/zzts/fxdj/count`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     *
     * @name YhdjCountList
     * @summary 综合态势-专项隐患等级数量统计
     * @request GET:/zzts/yhdj/count
     */
    yhdjCountList: (params: RequestParams = {}) =>
      this.request<object, any>({
        path: `/zzts/yhdj/count`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     *
     * @name JcbjCountList
     * @summary 综合态势-专项监测报警数量统计
     * @request GET:/zzts/jcbj/count
     */
    jcbjCountList: (params: RequestParams = {}) =>
      this.request<object, any>({
        path: `/zzts/jcbj/count`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     *
     * @name YjczCountList
     * @summary 综合态势-专项预警处置数量统计
     * @request GET:/zzts/yjcz/count
     */
    yjczCountList: (params: RequestParams = {}) =>
      this.request<object, any>({
        path: `/zzts/yjcz/count`,
        method: "GET",
        format: "json",
        ...params,
      }),
  };
  gspspDtransPubbasicfacilitiesinfo = {
    /**
